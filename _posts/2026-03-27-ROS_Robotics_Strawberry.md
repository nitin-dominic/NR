...
{%- capture success_text -%}
Remember following the steps below could be painful and extremely slow sometimes / somedays. Be consistent as this learning curve could lead to very fruitful results once you see robot picking strawberries. It happened with me!
{%- endcapture -%}
<div class="notice--success">{{ success_text | markdownify }}</div>
